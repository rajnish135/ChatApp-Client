...
//     //   console.log("Backend Response is: ",res);
...
//               type='button'
//               onClick={onClose}
//               className='border-primary border text-primary px-4 py-1 rounded hover:bg-primary hover:text-white bg-green-300'
//             >
//               Cancel
//             </button>
//             <button
//               type='submit'
//               className='border-primary bg-green-300 text-black border px-4 py-1 rounded hover:bg-green-500 hover:text-white'
//             >
//               Save
//             </button>
...
const EditUserDetails = ({ onClose, user }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`http://localhost:8000/api/update-user`, formData, {
        withCredentials: true,
      });
